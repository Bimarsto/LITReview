...
from contributions.views import flux, posts, \
    ...
    add_review_not_from_ticket, add_review_from_ticket, edit_review, delete_review
...
urlpatterns = [
    ...
    path('reviews/add/', add_review_not_from_ticket, name='add_review_not_from_ticket'),
