...
from contributions.views import flux, posts, \
    ...
    add_review_not_from_ticket, add_review_from_ticket, \
...
urlpatterns = [
    ...
    path('unfollows/<int:id_deleted>/',
         unfollow,
         name='unfollow'),
    path('tickets/add/',
         add_ticket,
         name='add_ticket'),
    path('tickets/edit/<int:ticket_id>/',
         edit_ticket,
         name='edit_ticket'),
    path('tickets/delete/<int:ticket_id>/',
         ...
         name='delete_ticket'),
    path('reviews/add/',
         add_review_not_from_ticket,
         name='add_review_not_from_ticket'),
    path('reviews/<int:ticket_id>/add/',
         add_review_from_ticket,
         name='add_review_from_ticket'),
    path('reviews/edit/<int:review_id>/',
         edit_review,
         name='edit_review'),
